...
//     // 1️⃣ Count assignments by status
//     const aggregation = await Assignment.aggregate([
//       {
//         $match: {
//           assignedTo: new mongoose.Types.ObjectId(studentId)
...
//       .populate("reviewHistory.by", "name role")
//       .sort({ updatedAt: sort === "asc" ? 1 : -1 })
//       .select("title category status updatedAt submittedAt reviewHistory"); 
...
//       if (!assignment) {
//         return res.status(404).json({
//           message: "Draft assignment not found"
//         });
//       }
...
//       // 🔔 (Optional for now) Notification stub
...
//       res.json({
//         message: "Assignment updated. You can resubmit now."
//       });
